...
class myHTTPFileArchive(http.server.BaseHTTPRequestHandler):
 
 
    server_version = "myHTTPFileArchive/" + __version__
...
def test(HandlerClass = myHTTPFileArchive,
